...
// Construye la configuración después de preparar las rutas locales que Wrangler
// lee al importar el plugin de Cloudflare.
export default defineConfig(async () => {
  // Mantiene el estado de Wrangler y Miniflare dentro del proyecto. Son ajustes
  // no secretos; el entorno de la aplicación pertenece a archivos `.env*` ignorados.
  process.env.WRANGLER_WRITE_LOGS ??= "false";
  process.env.WRANGLER_LOG_PATH ??= ".wrangler/logs";
  process.env.MINIFLARE_REGISTRY_PATH ??= ".wrangler/registry";

  // Wrangler fija la ruta de sus logs al importar el plugin de Cloudflare.
